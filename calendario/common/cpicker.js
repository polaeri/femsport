...
function cPicker(id1,id2,tb){
	...
	while (inField = inField.offsetParent) { //add offset of parent elements
		x += inField.offsetLeft - inField.scrollLeft;
		y += inField.offsetTop - inField.scrollTop;
	}
