...
define("BGND1","#c8ff59"); //background top
define("BGND2","#c8ff59"); //background body
...
define("BGNDA","#EDEDED"); //grid - time / weeknr column
define("BGNDB","#BDBDBD"); //grid - weekday 1
define("BGNDC","#FFFFDD"); //grid - weekday 2
define("BGNDD","#878787"); //grid - weekend 1
