...
require 'calendario/lctheme.php';
...
th {background:".BGND3.";font-size:15px;}
...
.floatR {float:right;}
.floatL {float:left;font-size:25px;}
.floatC {text-align:center;margin-top:-7px;}
.center {display:block; margin:auto;}
.inline {display:inline;}

.point {cursor:pointer;font-size:16px;}
.point:hover{color:purple;}
.arrow {cursor:default;}
.move {cursor:move;}
.hyper{font-size:16px;}
.hyper:hover {cursor:pointer; background:".BGND2."; overflow:hidden;font-size:30px;}
...
.// ---- canvas ----
"
header {padding:5px 20px; font:".($topBd ? ' bold' : '').($topIc ? ' italic' : '')." 13px/25px arial,sans-serif;".($topSw ? ' text-shadow: 0.2em 0.3em 0.2em #888;' : '')." text-align:center; background:".BGND1.";}
...
div.content {clear:both; position:absolute; left:0; top:60px; right:0; bottom:35px; padding:3px 26px 0 10px;}
...
.// -- view: all --
"
.viewHdr {display:inline-block; min-width:350px;font-size:20px;font-family:sans-serif;}
...
.event {margin:2px;}
.evtTitle {display:block;font-size:15px;font-family:sans-serif;}
